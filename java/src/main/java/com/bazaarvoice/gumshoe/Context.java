...
public class Context {
    ...
    public Context(String name, Context previous) {
        ...
        List<String> contexts = new ArrayList<String>((List<String>)previous.data.get("_context"));
        contexts.add(name);
        this.data.put("_context", contexts);
        this.data.put("_stream_id", streamId.toString());
    }
    ...
    public Context(UUID streamId, String name, EventFactory eventFactory, EventHandler eventDispatcher) {
        ...
        this.data.put("_context", contextPath);
        this.data.put("_stream_id", streamId.toString());
    }
